...
<html lang="en">
	<head>
		...
		<?php include($nested.'../../architecture/php/load-externals-beta.php'); ?>		
	</head>
	<body class="photo-page">		
		...
		<script type="text/javascript">
			...
			var zoomBottom = zoom - 3;
		</script>
		<script src="<?php echo $nested; ?>../../architecture/js/photopage_beta.js" type="text/javascript"></script>
	</body>
</html>