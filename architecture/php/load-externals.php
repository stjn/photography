<?php 
	...
	if($photoPage){
		$fbTitle = $placename . ' | ';
		$urlPrepend = $nested . '../../'; 
	  	echo '<link href="'.$nested.'../../architecture/mapbox/v1.6.2/mapbox.css" rel="stylesheet"/>';
...
<!-- CSS & Font Awesome -->
<link href="<?php echo $urlPrepend;?>architecture/css/style.css" rel="stylesheet">
<link href="//netdna.bootstrapcdn.com/font-awesome/4.1.0/css/font-awesome.min.css" rel="stylesheet" />
<link href="https://fonts.googleapis.com/css?family=Alata|Oswald|Rancho&display=swap" rel="stylesheet">
...
<script src="'.$nested.'../../architecture/mapbox/v1.6.2/mapbox.js" type="text/javascript"></script>'; }?>
