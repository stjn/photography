	...
	echo 
		"		<div class='duo wide'>
				...
				<div class='duo notebook'>
					<img data-original='" . $imageA . "' src='http://stijn.cc/resources/images/white.jpg' alt='' width='" . $notebookwidthA  . "' height='" . $notebookheight . "' class='first lazy'/>
					<img data-original='" . $imageB . "' src='http://stijn.cc/resources/images/white.jpg' alt='' width='" . $notebookwidthB  . "' height='" . $notebookheight . "' class='second lazy'/>
					<noscript>
...
function renderPhotos($photoarray){
	foreach ($photoarray as &$phoot) {
	    ...
	    echo "	<img class='lazy photo' data-original='" . $phoot . "' src='http://stijn.cc/resources/images/white.jpg' alt='' width='" . $widthH . "' height='" . $heightH . "'/><noscript><img class='photo' src='" . $phoot . "' alt='' width='" . $widthH . "' height='" . $heightH . "'/></noscript>" . "\n";
	   // echo"<img class='lazy photo phoot-small' data-original='" . $phootSmall . "' src='http://stijn.cc/resources/images/white.jpg' alt='' width='" . $widthSmall . "' height='" . $heightSmall . "'/><noscript><img class='photo phoot-small' src='" . $phootSmall . "' alt='' width='" . $widthSmall . "' height='" . $heightSmall . "'/></noscript>" . "\n";
	}
}	
?>